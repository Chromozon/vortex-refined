...
void setGeneralAbilities (edict_t *ent)
{
	...
	{
		enableAbility(ent, VAMPIRE, 0, 10, 1);
		enableAbility(ent, CLOAK, 0, 1, 1);
		enableAbility(ent, WEAPON_KNOCK, 0, 1, 1);
		enableAbility(ent, ARMOR_UPGRADE, 0, 10, 1);
		enableAbility(ent, AMMO_STEAL, 0, 10, 1);
		enableAbility(ent, SUPPLY_STATION, 0, 10, 1);
		//enableAbility(ent, FREEZE_SPELL, 0, 1, 1);
		enableAbility(ent, CREATE_QUAD, 0, 1, 1);
		enableAbility(ent, CREATE_INVIN, 0, 1, 1);
		enableAbility(ent, POWER_SHIELD, 0, 10, 1);
		enableAbility(ent, CORPSE_EXPLODE, 0, 10, 1);
		enableAbility(ent, GHOST, 0, 10, 1);
		enableAbility(ent, SALVATION, 0, 10, 1);
		enableAbility(ent, FORCE_WALL, 0, 10, 1);
		//	enableAbility(ent, AMMO_REGEN, 0, 5, 1);
		enableAbility(ent, BUILD_LASER, 0, 10, 1);
		enableAbility(ent, HA_PICKUP, 0, 10, 1);
		enableAbility(ent, BUILD_SENTRY, 0, 10, 1);
		enableAbility(ent, BLOOD_SUCKER, 0, 10, 1);
		enableAbility(ent, PROXY, 0, 10, 1);
		enableAbility(ent, MONSTER_SUMMON, 0, 10, 1);
		enableAbility(ent, ARMOR_REGEN, 0, 10, 1);
		enableAbility(ent, BOMB_SPELL, 0, 10, 1);
		enableAbility(ent, LIGHTNING, 0, 10, 1);
		enableAbility(ent, HOLY_FREEZE, 0, 10, 1);
		enableAbility(ent, CACODEMON, 0, 10, 1);
		enableAbility(ent, PLAGUE, 0, 10, 1);
		enableAbility(ent, FLESH_EATER, 0, 10, 1);
		enableAbility(ent, HELLSPAWN, 0, 10, 1);
		enableAbility(ent, BEAM, 0, 10, 1);
		enableAbility(ent, BRAIN, 0, 10, 1);
		enableAbility(ent, MAGMINE, 0, 10, 1);
		enableAbility(ent, CRIPPLE, 0, 10, 1);
		enableAbility(ent, MAGICBOLT, 0, 10, 1);
		enableAbility(ent, NOVA, 0, 10, 1);
		enableAbility(ent, EXPLODING_ARMOR, 0, 10, 1);
		enableAbility(ent, MIND_ABSORB, 0, 10, 1);
		enableAbility(ent, LIFE_DRAIN, 0, 10, 1);
		enableAbility(ent, AMP_DAMAGE, 0, 10, 1);
		enableAbility(ent, CURSE, 0, 10, 1);
		enableAbility(ent, BLESS, 0, 10, 1);
		enableAbility(ent, WEAKEN, 0, 10, 1);
		enableAbility(ent, HEALING, 0, 10, 1);
		//enableAbility(ent, AMMO_UPGRADE, 0, 5, 1);
		enableAbility(ent, YIN, 0, 10, 1);
		enableAbility(ent, YANG, 0, 10, 1);
		enableAbility(ent, FLYER, 0, 10, 1);
		enableAbility(ent, MUTANT, 0, 10, 1);
		enableAbility(ent, TANK, 0, 10, 1);
		enableAbility(ent, BERSERK, 0, 10, 1);
		enableAbility(ent, SPIKE, 0, 10, 1);
		enableAbility(ent, MORPH_MASTERY, 0, 1, 1);
		enableAbility(ent, NAPALM, 0, 10, 1);
		enableAbility(ent, MEDIC, 0, 10, 1);
		enableAbility(ent, METEOR, 0, 10, 1);
		enableAbility(ent, AUTOCANNON, 0, 10, 1);
		enableAbility(ent, HAMMER, 0, 10, 1);
		enableAbility(ent, SUPER_SPEED, 0, 1, 1);
		enableAbility(ent, FIRE_TOTEM, 0, 10, 1);
		enableAbility(ent, WATER_TOTEM, 0, 10, 1);
		enableAbility(ent, AIR_TOTEM, 0, 10, 1);
		enableAbility(ent, EARTH_TOTEM, 0, 10, 1);
		enableAbility(ent, DARK_TOTEM, 0, 10, 1);
		enableAbility(ent, NATURE_TOTEM, 0, 10, 1);
		enableAbility(ent, FURY, 0, 5, 1);
		enableAbility(ent, TOTEM_MASTERY, 0, 1, 1);
		enableAbility(ent, SHIELD, 0, 1, 1);
		enableAbility(ent, CALTROPS, 0, 10, 1);
		enableAbility(ent, SPIKE_GRENADE, 0, 10, 1);
		enableAbility(ent, DETECTOR, 0, 10, 1);
		enableAbility(ent, CONVERSION, 0, 10, 1);
		enableAbility(ent, DEFLECT, 0, 10, 1);
		enableAbility(ent, EMP, 0, 10, 1);
		enableAbility(ent, LOWER_RESIST, 0, 10, 1);
		enableAbility(ent, FIREBALL, 0, 10, 1);
		enableAbility(ent, PLASMA_BOLT, 0, 10, 1);
		enableAbility(ent, LIGHTNING_STORM, 0, 10, 1);
		enableAbility(ent, MIRV, 0, 10, 1);
		enableAbility(ent, SPIKER, 0, 10, 1);
		enableAbility(ent, OBSTACLE, 0, 10, 1);
		enableAbility(ent, GASSER, 0, 10, 1);
		enableAbility(ent, HEALER, 0, 10, 1);
		enableAbility(ent, SPORE, 0, 10, 1);
		enableAbility(ent, ACID, 0, 10, 1);
		enableAbility(ent, COCOON, 0, 10, 1);
		enableAbility(ent, SELFDESTRUCT, 0, 5, 1);
		enableAbility(ent, FLASH, 1, 1, 1);
	}
}
